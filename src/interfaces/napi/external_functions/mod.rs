pub use self::{
    address_type_external_function::*, block_hash_external_function::*,
    ...
    generic_external_function::*, inputs_external_function::*, outputs_external_function::*,
    storage_load_external_function::*, storage_store_external_function::*,
};

mod address_type_external_function;
