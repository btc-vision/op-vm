pub use self::{
    ...
    deploy_from_address_external_function::*, encode_address_external_function::*,
    external_function::*, generic_external_function::*, storage_load_external_function::*,
...
mod encode_address_external_function;
