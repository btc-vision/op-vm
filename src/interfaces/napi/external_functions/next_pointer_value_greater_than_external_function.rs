...
pub struct NextPointerValueGreaterThanExternalFunction {
    external_function: GenericExternalFunction,
}

impl NextPointerValueGreaterThanExternalFunction {
...
impl ExternalFunction for NextPointerValueGreaterThanExternalFunction {
